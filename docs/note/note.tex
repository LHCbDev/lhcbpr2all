...
build each project, one after the other in order of dependencies (as declared in
the configuration\footnote{The dependencies are not declared in the old
...
As already mentioned, the core tools are hosted in a GIT repository which
